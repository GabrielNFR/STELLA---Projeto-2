...
from .views import (
    EventoAgendaListCreate, FaseTratamentoList, ConviteCopilotoCreate, DiarioListCreate,
    MedicacaoListCreate, MedicacaoDetail, UserProfileRetrieveUpdateAPIView,
...
urlpatterns = [
    ...
    path("perfil/", UserProfileRetrieveUpdateAPIView.as_view(), name="user-profile"),
    path("perfil/foto/", UserProfilePhotoUpdateAPIView.as_view(), name="user-profile-photo"),
]
